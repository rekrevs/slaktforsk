# T-0464: Återbevara Degerfors A I/3 sida 262 och A I/7b sida 400 och utvinn barnraderna
...
P-0520–P-0525 gemensamt, plus P-0082 och P-0519. **Sex akters identitetsnivå faller på samma två bilder.** A I/7b sida 400 (`A0001440_00141`) är en faktiskt öppnad post där endast namn och år är avskrivna för barnraderna och där bilden saknas lokalt; bevarandet ägs enligt `genealogy/source-coverage.md` av T-0259. A I/3 sida 262 (`A0001433_00280`) saknar helt känd Wotan-ägare för återbevarande och är den äldsta volym där syskonens egna kolumner står. Hämta båda med post-URL och SHA-256 och utvinn varje persons egen rad kolumn för kolumn mot de tryckta rubrikerna. Det stänger PK-05 och PK-11 för sex personer på en gång. **Dubblera inte T-0259:s del.** Utanför: nya volymer och nya slutsatser.
