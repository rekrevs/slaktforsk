# T-0372: Pröva Anders Ivars yrkesled mot läkarmatrikel och missionsarkiv
...
P-0239 ensam. Kyrkoböckerna kallar honom `Kontorsbiträde` och därefter `Missionär`, aldrig läkare, vilket ställer den publicerade beteckningen missionärsläkare mot en samtida källa och skärper profilens Q-03. Pröva svensk läkarmatrikel och legitimationsregister för perioden, och därefter Svenska Missionsförbundets arkiv för hans utsändning och tjänstgöring. Ett negativt utfall i matrikeln är ett register- och årsbundet noll, inte ett bevis på att han saknade utbildning. Utanför: familjens övriga medlemmar och allt som kräver beställning innan en konkret volym är identifierad.
