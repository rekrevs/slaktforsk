# T-0442: Läs Bettna C/5 mars 1857 och Bettnas dödbok 1857 för P-0319
...
P-0319 ensam. Hennes födelse- och dopnotis i Bettna C/5 mars 1857 är oläst, trots att volymen S-0116 redan används i projektet. Läs den. Identifiera därefter Bettnas dödbok för 1857 i arkivförteckningen och läs den — hon dog som spädbarn, och dödsposten är den enda källa som kan ge dödsorsak och exakt ålder. **Kopptecknet `v` på hennes rad duger inte som vaccinationsbelägg:** det står likformigt på samtliga tolv rader i uppslaget, inklusive ett fjorton dagar gammalt barn. Högst en katalogväg och en volym per passage. Utanför: syskonens poster.
