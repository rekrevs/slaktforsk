# T-0403: Följ sida 824:s fem framåthänvisningar i rätt volym
...
P-0096, P-0101 och syskonkretsen. Sida 824 bär hänvisningarna `nb. 1096`, `1097`, `1098`, `853` och `820`, som billigast löses i ett enda pass. Volymen måste identifieras via ortsregister och får inte antas: motsvarande `nb. 1130` för Jomark visade sig avse Robertsfors `A II/2 a`, inte Bygdeå `A II a/5`, enligt C-0498. Pröva i samma passage syskonens värnpliktsnummer `46 175/1884` och `42 175/1900` samt de två `Frik.`-markeringarna, som saknar gemensam ägare. T-0267 och T-0268 gäller föräldraparet och ska inte dubbleras. Utanför: barnens egna vuxenliv efter första mottagarposten.
