# T-0380: Ställ en avgränsad ägarfråga om tre namnformer och DNA-spåret
...
P-0303, P-0304 och P-0007. Efternamnsformerna `Bratt` och `O'Donnell` förekommer i hela repositoriet endast i akttitlar, filnamn och hänvisningsrader — aldrig i en citation, källakt, forskningslogg eller Project Control-beslut. Det är en provenansbrist i personernas egna identifierare och håller båda identitetsnivåerna underkända. Sammanställ en kort ägarfråga om formerna och deras ursprung. Ta i samma fråga upp om DNA-spåret i C-0262, där en tredje namngiven person sammanfaller med P-0304:s registerform, ska hanteras vidare — det gäller genetisk uppgift om en levande person och kräver ägarbeslut. Detta är en frågelista, inte en arkivpassage: inga externa förfrågningar skickas och inget svar antas.
