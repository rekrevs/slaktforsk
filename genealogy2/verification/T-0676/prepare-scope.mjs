...
const dir='genealogy2/verification/T-0676/';
...
const group=groups.cohorts.find(x=>x.cohort_key==='G024');
const priority=JSON.parse(fs.readFileSync('genealogy2/verification/T-0673/priority.json'));
const claims=priority.claims.filter(x=>x.cohort_keys.includes('G024'));
...
fs.writeFileSync(dir+'scope.json',JSON.stringify({task:'T-0676',cohort:'G024',members:group.members,cross_references:group.cross_references,records},null,2)+'\n');
