# P-0164: Anna Lisa Jansdotter i Sköldinge

**Släktled:** farfars farmors mormors mor till
...
[Brita Kajsa Pehrsdotter](P-0126-brita-kajsa-pehrsdotter.md) → hon.
...
- Forskningsprofil: [P-0164](../research-profiles/P-0164.md) — individuell
...
föräldrafältet.
[C-0126](../citations/C-0126-brita-kajsa-fodelse-1829.md)

Åldern 20 år i oktober 1829 ger födelsetid mellan oktober 1808 och oktober
1809. Hennes födelseförsamling, exakta dag och föräldrar är okända, och
`Säfvesta[?]`:s geografiska bäring är inte fastställd genom ortregister.
`Identitetsläge` är därför `OLÖST` med sakligt avgränsat omfång.

**Dotterns patronymikon `Pehrsdotter` kommer inte från denna post** — notisen
namnger ingen far — utan från senare källor i dotterns egen akt.
...
|---|---|---|---|---|---|
| Mellan oktober 1808 och oktober 1809 | Född enligt åldern 20 år vid dottern dop; dag och församling okända | Okänd | — | Okänt | [C-0126](../citations/C-0126-brita-kajsa-fodelse-1829.md) |
| 1829-10-21 | Dottern Brita Kajsa föds; hon anges som ogift piga, 20 år, med hemvisten `Säfvesta[?]` | Sköldinge | Piga | Ingen make; ingen far införd | [C-0126](../citations/C-0126-brita-kajsa-fodelse-1829.md) |

**Två hållpunkter, varav den ena är härledd ur en ålder.** Hennes liv före och
efter oktober 1829 är helt okänt: ingen vigsel, inga övriga barn, ingen
flyttning, ingen död.
...
`Säfstugan`, och hustrur och barn kan dessutom vara kollektivt onamngivna i
flyttlistorna.
...
1808–1809. Ett **utomäktenskapligt** barn 1829 kunde däremot leda till
kyrkotukt eller ett faderskapsmål vid sockenstämma eller ting — en
källkategori som är rättsligt och kyrkligt relevant och som inte är sökt.
Ingen sådan handling är belagd, och ingen får antas.

## Hälsa och död

| Tid | Uppgift | Källa/belägg | Källkritisk kommentar |
|---|---|---|---|
| 1829-10-21 | Hon födde en dotter vid omkring 20 års ålder | [C-0126](../citations/C-0126-brita-kajsa-fodelse-1829.md) | Den enda kroppsliga händelse som är belagd. Ingen uppgift om förlossning, hälsa eller barnets amning finns. |

Hennes död är okänd och ingen dödsuppgift får antas. Hon var omkring 20 år
1829 och kan ha levt långt in på 1800-talet, i en period med tät
folkbokföring — vilket gör hennes fortsättning lätt att söka så snart en ort
eller ett hushåll är känt.

## Media och personliga källor

| Objekt | Datum | Upphov/provenans | Citation | Lokal fil |
|---|---|---|---|---|
| Sköldinge C/3, Brita Kajsas födelse- och dopnotis 1829 med vittneskolumn och förstorad läsvy | Läst 2026-08-20; vittneskolumn och boställe omkontrollerade 2026-08-21; hela kortposten prövad 2026-09-08 | Riksarkivet, bild 119 | [C-0126](../citations/C-0126-brita-kajsa-fodelse-1829.md) | [C-0126-riksarkivet-skoldinge-C3-bild-119-brita-kajsa-1829.jpg](../media/C-0126-riksarkivet-skoldinge-C3-bild-119-brita-kajsa-1829.jpg) |

Inget personligt material och ingen egen hand är känd.

## Biografisk sammanfattning

Anna Lisa Jansdotter är känd ur en enda rad. Den 21 oktober 1829 föddes hennes
dotter Brita Kajsa i Sköldinge, och dopnotisen anger henne som `Pigan Anna
Lisa Jansdotter`, **20 år**, med hemvisten `Säfvesta[?]`. Ingen far är införd i
föräldrafältet — barnet var fött utom äktenskapet, och det är postens
uttryckliga uppgift. [C-0126](../citations/C-0126-brita-kajsa-fodelse-1829.md)

Åldern är hennes enda datumnyckel: 20 år i oktober 1829 ger födelsetid mellan
oktober 1808 och oktober 1809. Hemvisten är hennes enda ortnyckel, och dess
läsning bär reservation — den äldre säkra formen `Säfstugan` upphävdes i
T-0137, vilket samtidigt tog bort räckvidden ur tre negativa kontroller som
...
- Ingen konflikt finns inom det lästa underlaget. De tre negativa
  kontrollerna motsäger henne inte; de gällde en upphävd ortläsning.
...
- Genomsökt: dotterns födelsenotis i Sköldinge 1829, nu utvunnen inklusive
  ålder, hemvist och vittneskolumn; Säfstugan i A I/9 och A I/10; samt
  flyttningslängdens hela följd 1829–1830.
...
sin första profil. Inget A-id är borttaget; A-7400–A-7402 tillkommer ur den
...
Att vittnet bär hennes patronymikon **och** bor på hennes hemvist är den enda
ingång till hennes släkt som projektet har.

Den tidigare `Arbetsläge`-lydelsen står kvar i sak och är utvidgad; T-0137:s
begränsade följdavstämning bevaras nedan som historik.

> ### Begränsad följdavstämning — T-0137, 2026-09-08
>
> C-0126:s hela kortpost har prövats: Anna Lisa Jansdotter är ogift piga, 20
> år, med hemvist Säfvesta[?]; äldre säker Säfstugan upphävs. Fyra dopvittnen
> och svag struken af…-not är bevarade i citationen/P-0126. T-0308 äger högst
> två register och två personbundna folier; T-0307 kopie-/referensbrister.
> Individuell profilinföring och full granskning ägs av T-0169, inte denna
> begränsade följd.
>
