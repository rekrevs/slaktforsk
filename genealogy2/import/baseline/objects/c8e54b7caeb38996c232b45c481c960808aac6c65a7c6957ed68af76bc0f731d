# P-0515: Olof Nilsson i Rinkaby

**Släktled:** morfars morfars morfars far till
...
→ [Anders Ringberg](P-0388-anders-ringberg.md) → han.
...
- Trädverkan: `AVVAKTAR` — `Identitetsläge` är `OLÖST`: hans åldersuppgift är
  ...
  Relationen nedåt till sonen är dubbelbelagd.
- Kontraktsgranskning: `UNDERKÄND`
- Forskningsprofil: [P-0515](../research-profiles/P-0515.md) — individuell
  granskning 2026-09-09, T-0172.

## Identitet

Olof Nilsson är hemmansbrukare i Södra Rinkaby i Hossmo och far till
[Anders Ringberg](P-0388-anders-ringberg.md).

Hans föräldraroll är **dubbelbelagd**: hushållssidan Hossmo A I/3 sida 156
visar honom med hustrun Maja Jonsdotter, dottern Cajsa och sonen Anders, och
Sjöströms nominativa uppgift om Kalmar nation knyter uttryckligen den vuxne
Anders Ringberg till `fadern Olof Nilsson, hemmansbrukare i Rinkaby, Hossmo
socken`.
...
| [P-0516 Maja Jonsdotter](P-0516-maja-jonsdotter-rinkaby.md) | hustru/medförälder | Södra Rinkaby, Hossmo 1810–1811 | TRANSCRIBED | [C-0849](../citations/C-0849-hossmo-AI3-anders-ringberg-foraldrar.md) |
...
Hans föräldrar och syskon är okända. Dottern Cajsa får inget eget person-id
här.
...
|---|---|---|---|---|---|
| Omkring 1760–1761 | Född enligt hushållssidans åldrar; ort okänd | Okänd | — | Okänt | [C-0849](../citations/C-0849-hossmo-AI3-anders-ringberg-foraldrar.md) |
| 1810 | Egen hushållsrad, 49 år, med `abs.` i årskolumnen | Södra Rinkaby `N:o 1`, Hossmo | Hemmansbrukare | Hustru, dotter och son | [C-0849](../citations/C-0849-hossmo-AI3-anders-ringberg-foraldrar.md) |
| 1811 | Samma rad, 50 år | Södra Rinkaby `N:o 1`, Hossmo | Hemmansbrukare | Hustru, dotter och son | [C-0849](../citations/C-0849-hossmo-AI3-anders-ringberg-foraldrar.md) |
| Under bokens tid | Hushållsblocket överstruket; anteckningen i högerkolumnen är oläst | Södra Rinkaby, Hossmo | Hemmansbrukare | — | [C-0849](../citations/C-0849-hossmo-AI3-anders-ringberg-foraldrar.md) |

De omkring 49 åren före 1810 har **ingen** hållpunkt, och ingenting efter
bokens tid är belagt.
...
beväringsålder under 1780- och 1790-talen om åldersuppgiften är riktig, men
en hemmansbrukare var normalt rotehållare snarare än soldat, och ingen
rotebeteckning utöver gårdsnumret är känd.

## Hälsa och död

| Tid | Uppgift | Källa/belägg | Källkritisk kommentar |
|---|---|---|---|
| 1810–1811 | `abs.` i årskolumnerna på hans egen rad 1810 | [C-0849](../citations/C-0849-hossmo-AI3-anders-ringberg-foraldrar.md) | Frånvaro vid förhöret är den enda uppgiften, och den säger inget om hälsa. Se A-7602. |

Hans död är okänd och osökt. Med åldersuppgiften finns nu en nyckel som kan
...
Sjöströms nominativa uppgift är en tryckt sekundärkälla. Inget personligt
material och ingen egen hand är känd.

## Biografisk sammanfattning

Olof Nilsson brukade hemmanet `N:o 1` i Södra Rinkaby i Hossmo. Hans
föräldraroll är ovanligt väl belagd för en anspets: både en samtida
hushållssida och en **oberoende** nominativ uppgift om Kalmar nation knyter
...
konsistenskontroll. [A-7600](#påståenden)
...
sin första profil. Inget A-id är borttaget; A-7600–A-7603 tillkommer ur den
...
Därtill var frånvaromarkeringarna `abs.`, hushållsblockets överstrykning och
högerkolumnens anteckning outvunna.

`Källbredd` är ändrad från `KLAR` till `PÅGÅR`. Äldre lydelse, ersatt
2026-09-09:

> - Konsolidering: `GRANSKAD` 2026-09-04 (T-0043)
> - Källbredd: `KLAR` — föräldrarollen är dubbelbelagd, men nästa generation
>   kan inte nås säkert från nuvarande identitetsprofil.

Bedömningen var riktig om föräldrarollen, som är dubbelbelagd. Den byggde på
att identitetsprofilen var uttömd — men sidan bar hans egen ålder i två
kolumner.
