# P-0171: Anna Lena Jonathansdotter, piga i Krokbäck, dopvittne 1840
...
- Profil: [P-0171](../research-profiles/P-0171.md) — daterad PK-bedömning, tio
...
**Fyra led står i källan:** ståndet `Pig:`, förnamnet, patronymikonet
`Jonathansdotter` och orten. Ortledet är nu upplöst till `Krokbäck` — se
nedan. Ingen ålder finns.

**Hennes patronymikon är kohortens starkaste enskilda söknyckel.**
`Jonathansdotter` är sällsynt i Västerbotten på 1800-talet, till skillnad från
kohortens `Andersson`, `Pehrsson` och `Jonsson`. Ett ovanligt patronymikon
gör en piga sökbar där ett vanligt namn inte gör det.

**Ortledet är rättat.** Citationens avskrift lämnade orten `svårläst`, och
T-0131 läste den `Tväråbäck[?]` den 8 september 2026 med uttrycklig
reservation. Omläsningen 2026-09-10 läser `Krokbäck` — bokstäverna `K-r-o-k`
och `ä`-punkterna är entydiga, och ordet har inte `Tväråbäck`s form.
Reservationen är därmed upplöst åt ett annat håll än den pekade.

**Förnamnet är däremot nu osäkert.** Tre tidigare läsningar skriver
`Anna Lena`; omläsningen 2026-09-10 läser andra förnamnet som `Sara[?]`.
Ingen av läsningarna väljs bort. Aktens visningsnamn behålls oförändrat,
och konflikten förs som en öppen fråga — ett namnbyte på fyra tidigare
läsningars bekostnad kräver mer än en fjärde läsning.

**Och en förväxling måste hållas ifrån akten.** Dopbarnets mor heter
`Anna Stina Jonsd:r`. `Jonsdotter` och `Jonathansdotter` är inte samma
patronymikon — det ena pekar på en far vid namn Jon eller Jöns, det andra på
en vid namn Jonathan. Ingen syskonhypotes registreras, men frågan om
`Jonsd:r` kan vara en förkortning av `Jonathansd:r` är inte prövad.
...
| `Anna Lena Jonathansdotter` | aktens visningsnamn | TRANSCRIBED | [C-0121](../citations/C-0121-maria-christina-fodelse-1840.md) | Normaliserad form av samma led. |

## Påståenden

| ID | Påstående | Status | Tillförlitlighet | Belägg | Kommentar |
|---|---|---|---|---|---|
| A-0747 | Pigan Anna Lena Jonathansdotter var dopvittne åt Maria Christina 1840. | TRANSCRIBED | medel | [C-0121](../citations/C-0121-maria-christina-fodelse-1840.md) | Namnet är läsbart; orten lämnas osäker. |
| A-7850 | **Vittnesledet är fullt utvunnet.** **Fyra led står i källan:** ståndet `Pig:`, förnamnet, patronymikonet
`Jonathansdotter` och orten. Ortledet är nu upplöst till `Krokbäck` — se
nedan. Ingen ålder finns. | TRANSCRIBED | hög | [C-0121](../citations/C-0121-maria-christina-fodelse-1840.md) | Konsoliderat 2026-09-10 i T-0186. Ingen ny arkivsökning. Omläsning av den redan sparade helbilden `A0004528_00091`; se citationens tillägg samma dag. Att åldern saknas är en källgräns, inte en läsosäkerhet — dopvittneskolumnen har ingen åldersruta. |
...
|---|---|---|---|---|---|
| 1840-10-31 | dopvittne | Krokbäck | vittnesledets ståndsbeteckning | — | [C-0121](../citations/C-0121-maria-christina-fodelse-1840.md) |
...
|---|---|---|---|---|
| 1840-10-31 | Krokbäck | — | [C-0121](../citations/C-0121-maria-christina-fodelse-1840.md) | Byn står på hans eget led. |
...
|---|---|---|---|---|
| 1840 | se vittnesledets ståndsbeteckning ovan | Krokbäck | [C-0121](../citations/C-0121-maria-christina-fodelse-1840.md) | `Pig:` är hennes egen ståndsbeteckning — hon tjänade i ett hushåll, och byn anger var. |
...
|---|---|---|---|---|
| 1840-10-31 | betrodd som dopvittne | församlingen | [C-0121](../citations/C-0121-maria-christina-fodelse-1840.md) | En piga som stod fadder var betrodd i församlingen. Att hon förs sist av postens tre parter säger inget belagt. |
...
Den 1840-10-31 stod Anna Lena Jonathansdotter fadder när [P-0095 Maria Christina Hansdotter](P-0095-maria-christina-hansdotter.md) döptes. Det är allt
...
1. Vad är hennes andra förnamn, och var ligger Krokbäck? Se profilens Q-01.
...
Rubriken saknade år och roll. Den lyder nu `P-0171: Anna Lena Jonathansdotter, piga i Krokbäck, dopvittne 1840`, eftersom
