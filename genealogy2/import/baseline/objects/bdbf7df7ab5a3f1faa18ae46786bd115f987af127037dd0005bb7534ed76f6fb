# P-0150: Olof, äldste sonen i Rödå
...
- Profil: [P-0150](../research-profiles/P-0150.md) — daterad PK-bedömning, tio
...
- Hela den egna raden är nu utvunnen ur den redan sparade bilden
  `A0001442_00171`; ingen ny arkivsökning. Se A-7838.

## Identitet

Äldste sonen till bonden och nämndemannen [P-0145 Anders Olofsson](P-0145-anders-olofsson-namndeman-roda.md) och hans hustru [P-0148 Sofia Magdalena Jonsdotter](P-0148-sofia-magdalena-jonsdotter.md) i
**Rödå** i Degerfors, född 1829-10-30 enligt föräldrahushållets
husförhörslängd, trettioett år när längden lades upp 1861.
...
Hans inflyttningscell är den enda i barnraden som pekar på en annan ort inom socknen. Ordet är olöst: T-0139 läste `omBrån[?]` 2026-09-08, och omläsningen 2026-09-10 ger `p:a Brån[?]`. Byn Brån finns i församlingen, vilket gör läsningen rimlig — men rimlighet är inte belägg, och ingen kandidatläsning fastställs.
...
|---|---|---|---|---|
| `Olof` | 1861–1865, husförhörslängdens barnkolumn | TRANSCRIBED | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Källans form — enbart förnamnet. Barnen förs utan efternamn under `Barn:`. |
| `Olof Andersson` | aktens visningsnamn | LEAD | — | **Ingen källa skriver efternamnet.** Det är ett patronymikon efter fadern Anders och måste märkas som projektets normalisering i varje sökning. |
| `Olof Anders son` | ej belagd | LEAD | — | Måste ingå i varje sökning. Patronymikon skrevs växelvis fullt ut och förkortat i tidens längder. |

## Påståenden

| ID | Påstående | Status | Tillförlitlighet | Belägg | Kommentar |
|---|---|---|---|---|---|
| A-0635 | Namnet var Olof. | TRANSCRIBED | hög | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Barnkolumnen; patronymikon efter fadern Anders. |
| A-0636 | Hen var född 1829-10-30 i Degerfors församling. | TRANSCRIBED | hög | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Exakt datum i uppslaget. |
| A-7838 | Hela den egna raden är utvunnen. `Koppor.` bär `v`, `Läser och förstår` en kunskapsbåge, och `Inflyttad från Socken, Län, Stad, eller transp. från fol.` bär `p:a Brån[?]` — en överföringshänvisning inom församlingen. `Anteckningar om frejd eller särskilde förhållanden` bär en kort egen not vars ord slutar `…Bor…[?]`. Hans döds- och utflyttningsfält är lästa tomma. Årskolumnerna 1861–1865 bär nattvardsbråk i samtliga fem år — han är den ende av syskonen med en obruten femårsföljd vid sidan av Carl Petter. | TRANSCRIBED | hög | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Ny läsning av den redan sparade bilden `A0001442_00171` 2026-09-10 i T-0185; ingen ny arkivsökning. Uppslagets tryckta kolumner är redovisade i citationens tillägg samma dag. De tomma fälten är lästa nollor — samma kolumner är ifyllda på andra rader i samma hushåll. |
...
| [P-0151 Jonas](P-0151-jonas-andersson-roda.md), [P-0152 Anna Lisa](P-0152-anna-lisa-andersdotter-roda.md), [P-0153 Carl Petter](P-0153-carl-petter-andersson-roda.md), [P-0154 Anders](P-0154-anders-andersson-roda.md), [P-0155 Maria Johanna](P-0155-maria-johanna-andersdotter-roda.md), [P-0156 Sara Mathilda](P-0156-sara-mathilda-andersdotter-roda.md), [P-0157 Hedda Fredrika](P-0157-hedda-fredrika-andersdotter-roda.md) | övriga syskon, samtliga förda under `Barn:` på samma uppslag | Rödå i Degerfors, 1861–1865 | TRANSCRIBED | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) |
...
|---|---|---|---|---|---|
| 1829-10-30 | född — hushållsuppgift, ingen läst födelsepost | Degerfors församling | — | föräldrarnas | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) |
...
| perioden | inflyttningscellen bär `p:a Brån[?]` — en överföring inom församlingen, utan årtal | — | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Övriga flyttfält är lästa tomma. |
...
|---|---|---|---|---|
| 1861–1865 | nattvardsbråk i samtliga fem år 1861–1865 | Degerfors församling | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Fraktionerna är prövade men reserverade: årskolumnerna ligger långt från namnkolumnen och raderna tätt. |
...
Olof var äldst av nio syskon i nämndeman Anders Olofssons hushåll i
**Rödå**, född den 30 oktober 1829. När husförhörslängden lades upp 1861 var
han trettioett år och bodde alltjämt hemma, utan eget stånd — vilket i
sig säger något: en vuxen bondson utan yrkesbeteckning arbetade normalt på
faderns hemman.

**Hans rad bär den enda ortshänvisningen bland syskonen.** Inflyttningscellen
skriver `p:a Brån[?]`, en överföring inom församlingen, och brodern Jonas
rad bär `d:o` — de två äldsta sönerna kom alltså till uppslaget från samma
håll. Ordet är olöst: T-0139 läste `omBrån[?]`, omläsningen ger
`p:a Brån[?]`. Byn Brån finns i församlingen, men rimlighet är inte
belägg.

**Han gick till nattvard i alla fem åren 1861–1865**, den tätaste följden
bland syskonen jämte Carl Petters. Efter 1865 slutar längden, och ingenting
mer är känt.

## Forskningsfrågor och konflikter

1. Var låg orten i hans inflyttningscell, och när kom han därifrån? Se profilens Q-01.
2. Födelsedatumet är en hushållsuppgift. Degerfors födelse- och dopbok för
   1829 är inte läst, och den vore det första oberoende belägget för
...
Rubriken löd `P-0150: Olof`. Den lyder nu `P-0150: Olof, äldste sonen i Rödå`, eftersom
