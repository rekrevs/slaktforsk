...
- Profil: [P-0154](../research-profiles/P-0154.md) — daterad PK-bedömning, tio
...
- Hela den egna raden är nu utvunnen ur den redan sparade bilden
  `A0001442_00171`; ingen ny arkivsökning. Se A-7843.

## Identitet

Sjätte barnet till bonden och nämndemannen [P-0145 Anders Olofsson](P-0145-anders-olofsson-namndeman-roda.md) och hans hustru [P-0148 Sofia Magdalena Jonsdotter](P-0148-sofia-magdalena-jonsdotter.md) i
**Rödå** i Degerfors, född 1846-05-09 enligt föräldrahushållets
husförhörslängd, femton år när längden lades upp 1861.
...
**Att 1861 är tomt och 1862 ifyllt är förenligt med hans ålder.** Han fyllde femton år i maj 1861, och första nattvardsgången följde normalt på konfirmationen omkring sexton år. Iakttagelsen är en tidsföljd i källan, inte ett belägg för en konfirmation — ingen konfirmationsbok är läst.
...
|---|---|---|---|---|
| `Anders` | 1861–1865, husförhörslängdens barnkolumn | TRANSCRIBED | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Källans form — enbart förnamnet. Barnen förs utan efternamn under `Barn:`. |
| `Anders Andersson` | aktens visningsnamn | LEAD | — | **Ingen källa skriver efternamnet.** Det är ett patronymikon efter fadern Anders och måste märkas som projektets normalisering i varje sökning. |
| `Anders Anders son` | ej belagd | LEAD | — | Måste ingå i varje sökning. Patronymikon skrevs växelvis fullt ut och förkortat i tidens längder. |

## Påståenden

| ID | Påstående | Status | Tillförlitlighet | Belägg | Kommentar |
|---|---|---|---|---|---|
| A-0643 | Namnet var Anders. | TRANSCRIBED | hög | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Barnkolumnen; patronymikon efter fadern Anders. |
| A-0644 | Hen var född 1846-05-09 i Degerfors församling. | TRANSCRIBED | hög | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Exakt datum i uppslaget. |
| A-7843 | Hela den egna raden är utvunnen. `Koppor.` bär `v` och `Läser och förstår` en kunskapsbåge med prickad understrykning — en annan form än de äldre syskonens hela bågar. Inflyttnings-, utflyttnings- och dödsfälten är lästa tomma, liksom `Anteckningar`. Årskolumnerna bär nattvardsbråk från 1862 och framåt; 1861 är läst tomt. | TRANSCRIBED | hög | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Ny läsning av den redan sparade bilden `A0001442_00171` 2026-09-10 i T-0185; ingen ny arkivsökning. Uppslagets tryckta kolumner är redovisade i citationens tillägg samma dag. De tomma fälten är lästa nollor — samma kolumner är ifyllda på andra rader i samma hushåll. |
...
|---|---|---|---|---|---|
| 1846-05-09 | född — hushållsuppgift, ingen läst födelsepost | Degerfors församling | — | föräldrarnas | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) |
...
|---|---|---|---|---|
| 1861–1865 | nattvardsbråk från 1862 till 1865; 1861 läst tomt | Degerfors församling | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Fraktionerna är prövade men reserverade: årskolumnerna ligger långt från namnkolumnen och raderna tätt. |
...
Anders bar **faderns namn** och var det sjätte av nio syskon i Rödå, född den
9 maj 1846. Han var femton år när längden lades upp och nitton när den
slutade.

**Hans rad visar en tidsföljd snarare än en händelse.** Årskolumnen för 1861
är läst tom, och nattvardsbråken börjar 1862 och fortsätter till
1865. Han fyllde femton i maj 1861, och första nattvardsgången följde
normalt på konfirmationen omkring sexton år — men ingen konfirmationsbok
är läst, och iakttagelsen är en tidsföljd i källan, inte ett belägg.

Hans kunskapsbåge har en **prickad understrykning** som skiljer sig från de
äldre syskonens hela bågar. Formen omtolkas inte till ett betyg. Efter
1865 är ingenting känt.

## Forskningsfrågor och konflikter

1. När konfirmerades han, och vad blev han sedan? Se profilens Q-01.
2. Födelsedatumet är en hushållsuppgift. Degerfors födelse- och dopbok för
   1846 är inte läst, och den vore det första oberoende belägget för
...
Rubriken löd `P-0154: Anders`. Den lyder nu `P-0154: Anders, som bar faderns namn`, eftersom
