# P-0155: Maria Johanna, tolv år 1861
...
- Profil: [P-0155](../research-profiles/P-0155.md) — daterad PK-bedömning, tio
...
- Hela den egna raden är nu utvunnen ur den redan sparade bilden
  `A0001442_00171`; ingen ny arkivsökning. Se A-7844.

## Identitet

Sjunde barnet till bonden och nämndemannen [P-0145 Anders Olofsson](P-0145-anders-olofsson-namndeman-roda.md) och hans hustru [P-0148 Sofia Magdalena Jonsdotter](P-0148-sofia-magdalena-jonsdotter.md) i
**Rödå** i Degerfors, född 1849-08-02 enligt föräldrahushållets
husförhörslängd, tolv år när längden lades upp 1861.
...
**De tomma årskolumnerna är väntade och ändå värda att skriva ut.** Hon var tolv år 1861 och sexton 1865 — under nattvardsåldern under nästan hela perioden. Tomheten är alltså en läst nolla med en självklar förklaring, inte en lucka i utvinningen. Det är också hela hennes akt: en rad, ett datum och nio tomma fält.
...
|---|---|---|---|---|
| `Maria Johanna` | 1861–1865, husförhörslängdens barnkolumn | TRANSCRIBED | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Källans form — enbart förnamnet. Barnen förs utan efternamn under `Barn:`. |
| `Maria Johanna Andersdotter` | aktens visningsnamn | LEAD | — | **Ingen källa skriver efternamnet.** Det är ett patronymikon efter fadern Anders och måste märkas som projektets normalisering i varje sökning. |
| `Maria Johanna Anders dr` | ej belagd | LEAD | — | Måste ingå i varje sökning. Patronymikon skrevs växelvis fullt ut och förkortat i tidens längder. |

## Påståenden

| ID | Påstående | Status | Tillförlitlighet | Belägg | Kommentar |
|---|---|---|---|---|---|
| A-0645 | Namnet var Maria Johanna. | TRANSCRIBED | hög | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Barnkolumnen; patronymikon efter fadern Anders. |
| A-0646 | Hen var född 1849-08-02 i Degerfors församling. | TRANSCRIBED | hög | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Exakt datum i uppslaget. |
| A-7844 | Hela den egna raden är utvunnen. `Koppor.` bär `v` och `Läser och förstår` en kunskapsbåge med prickad understrykning. Samtliga övriga egna fält är lästa tomma: inflyttning, utflyttning, död, `Anteckningar` — och alla fem årskolumnerna 1861–1865. En diagonal bläckstrek löper över uppslaget och korsar hennes rad i årsfälten; det är ett sidmärke och ingen notering. | TRANSCRIBED | hög | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Ny läsning av den redan sparade bilden `A0001442_00171` 2026-09-10 i T-0185; ingen ny arkivsökning. Uppslagets tryckta kolumner är redovisade i citationens tillägg samma dag. De tomma fälten är lästa nollor — samma kolumner är ifyllda på andra rader i samma hushåll. |
...
|---|---|---|---|---|---|
| 1849-08-02 | född — hushållsuppgift, ingen läst födelsepost | Degerfors församling | — | föräldrarnas | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) |
...
Maria Johanna var det sjunde av nio syskon i Rödå, född den 2 augusti
1849. Hon var tolv år när längden lades upp och sexton när den slutade.

Hennes akt ryms på en rad, och det är ingen brist i utvinningen. Namnet,
födelsedatumet, koppympningens `v` och en kunskapsbåge — och därefter **nio
lästa nollor**: inflyttning, utflyttning, död, anteckningar och alla fem
årskolumnerna. Tomheten har en självklar förklaring: hon var under
nattvardsåldern under nästan hela perioden.

En diagonal bläckstrek löper över uppslaget och korsar hennes rad i
årsfälten. Det är ett sidmärke, ingen notering, och det tolkas inte.

**En namnfråga står öppen på annat håll.** [P-0066](P-0066-lotta-sofia-andersdotter.md):s
profil frågar i sin Q-02 om pigan `Maria Johanna Andersdotter` i Rödå 1870 är
hennes syster. Den frågan får inte besvaras med namnlikhet, och den
besvaras inte här.

## Forskningsfrågor och konflikter

1. Vad hände med henne efter 1865? Se profilens Q-01.
2. Födelsedatumet är en hushållsuppgift. Degerfors födelse- och dopbok för
   1849 är inte läst, och den vore det första oberoende belägget för
...
Rubriken löd `P-0155: Maria Johanna`. Den lyder nu `P-0155: Maria Johanna, tolv år 1861`, eftersom
