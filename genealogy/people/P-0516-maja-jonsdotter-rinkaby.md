# P-0516: Maja Jonsdotter i Rinkaby

**Släktled:** morfars morfars morfars mor till
...
→ [Anders Ringberg](P-0388-anders-ringberg.md) → hon.
...
- Trädverkan: `AVVAKTAR` — `Identitetsläge` är `OLÖST`: hennes åldersuppgift
  är en husförhörsuppgift utan läst födelsepost, och hennes ursprung är
  okänt. Relationen nedåt till sonen är dubbelbelagd.
- Kontraktsgranskning: `UNDERKÄND`
- Forskningsprofil: [P-0516](../research-profiles/P-0516.md) — individuell
  granskning 2026-09-09, T-0172.

## Identitet

Maja Jonsdotter är hustru i Olof Nilssons hushåll i Södra Rinkaby i Hossmo
och mor till [Anders Ringberg](P-0388-anders-ringberg.md).

Hennes moderroll bärs av hushållssidan Hossmo A I/3 sida 156, där hon står
som `H: Maja Jonsd:r` med maken, dottern Cajsa och sonen Anders; Sjöströms
nominativa uppgift om Kalmar nation knyter sonen till **fadern** och därmed
till samma hushåll.
...
|---|---|---|---|---|
| [P-0388 Anders Ringberg](P-0388-anders-ringberg.md) | son | Södra Rinkaby, Hossmo 1810–1811; nio respektive tio år | CORROBORATED | [C-0849](../citations/C-0849-hossmo-AI3-anders-ringberg-foraldrar.md) |
| [P-0515 Olof Nilsson](P-0515-olof-nilsson-rinkaby.md) | make/medförälder | Södra Rinkaby, Hossmo 1810–1811 | TRANSCRIBED | [C-0849](../citations/C-0849-hossmo-AI3-anders-ringberg-foraldrar.md) |
| Cajsa, född omkring 1793–1794 | dotter | Södra Rinkaby, Hossmo; egen rad `D: Cajsa` | TRANSCRIBED | [C-0849](../citations/C-0849-hossmo-AI3-anders-ringberg-foraldrar.md) |

Hennes föräldrar och syskon är okända. Dottern Cajsa får inget eget person-id
här.
...
|---|---|---|---|---|---|
| Omkring 1769–1770 | Född enligt hushållssidans åldrar; ort okänd | Okänd | — | Okänt | [C-0849](../citations/C-0849-hossmo-AI3-anders-ringberg-foraldrar.md) |
| Omkring 1793–1794 | Dottern Cajsa föds; hon är då omkring 24 år | Okänd; sannolikt Hossmo | Hustru | Maken | [C-0849](../citations/C-0849-hossmo-AI3-anders-ringberg-foraldrar.md) |
| Omkring 1800–1801 | Sonen Anders föds; hon är då omkring 31 år | Hossmo | Hustru | Maken och dottern | [C-0849](../citations/C-0849-hossmo-AI3-anders-ringberg-foraldrar.md) |
| 1810 och 1811 | Egen hushållsrad, 40 respektive 41 år, med `abs.` båda åren | Södra Rinkaby `N:o 1`, Hossmo | Hustru | Maken, dottern och sonen | [C-0849](../citations/C-0849-hossmo-AI3-anders-ringberg-foraldrar.md) |
| Under bokens tid | Hushållsblocket överstruket; anteckningen i högerkolumnen är oläst | Södra Rinkaby, Hossmo | Hustru | — | [C-0849](../citations/C-0849-hossmo-AI3-anders-ringberg-foraldrar.md) |

**De två mellersta hållpunkterna är härledda ur barnens åldrar**, inte ur
egna poster. De omkring 24 åren före dotterns födelse har ingen hållpunkt.
...
|---|---|---|---|---|
| 1810–1811 | Hustru i ett hemmansbrukarhushåll på `N:o 1` | Södra Rinkaby, Hossmo | [C-0849](../citations/C-0849-hossmo-AI3-anders-ringberg-foraldrar.md) | Civilstånd, inte yrke. Hushållets jordnatur och omfattning är okända, och ingen jordebok eller mantalslängd är sökt. |
...
1769. Inget civilt eller rättsligt spår är sökt. Bedömningen är personbunden
och stänger inte hushållets spår.
...
användas i en dödboksökning.

## Media och personliga källor

| Objekt | Datum | Upphov/provenans | Citation | Lokal fil |
|---|---|---|---|---|
| Hossmo A I/3 sida 156, Södra Rinkaby, hela uppslaget | Läst tidigare; omläst 2026-09-09 vid 260–600 % | Riksarkivet, bild `C0027360_00082` | [C-0849](../citations/C-0849-hossmo-AI3-anders-ringberg-foraldrar.md) | [C-0849-riksarkivet-hossmo-AI3-C0027360_00082-s156.jpg](../media/C-0849-riksarkivet-hossmo-AI3-C0027360_00082-s156.jpg) |

Inget personligt material och ingen egen hand är känd.

## Biografisk sammanfattning

Maja Jonsdotter var hustru i hemmansbrukaren Olof Nilssons hushåll på `N:o 1`
...
är en intern konsistenskontroll. [A-7610](#påståenden)
...
- Ingen aktiv konflikt finns. Sonens åldrar **stöder** hans kända födelseår.
...
- Genomsökt: Hossmo A I/3 sida 156, nu utvunnen med hela hushållets åldrar,
  frånvaromarkeringar, överstrykning och högerkolumnens anteckning, samt den
  oberoende nominativa Kalmar-nationsnyckeln.
...
sin första profil. Inget A-id är borttaget; A-7610–A-7613 tillkommer ur den
...
Därtill var hennes `abs.`-markeringar båda åren, hushållsblockets
överstrykning och högerkolumnens anteckning outvunna.
...
Bedömningen var riktig om moderrollen. Den byggde på att identitetsprofilen
var uttömd — men sidan bar hennes egen ålder i två kolumner.
