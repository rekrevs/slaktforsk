# P-0151: Jonas, andre sonen i Rödå
...
- Profil: [P-0151](../research-profiles/P-0151.md) — daterad PK-bedömning, tio
...
- **Hela den egna raden är nu utvunnen** ur den redan sparade bilden
  `A0001442_00171`; ingen ny arkivsökning. Se A-7839.

## Identitet

Andre sonen till bonden och nämndemannen [P-0145 Anders Olofsson](P-0145-anders-olofsson-namndeman-roda.md) och hans hustru [P-0148 Sofia Magdalena Jonsdotter](P-0148-sofia-magdalena-jonsdotter.md) i
**Rödå** i Degerfors, född **1831-06-15** enligt föräldrahushållets
husförhörslängd, **trettio år** när längden lades upp 1861.
...
**Skillnaden mot brodern är påfallande och ligger i årskolumnerna.** Olof har fem år av noteringar, Jonas ett enda. **Tomheten är förd, inte utelämnad** — samma kolumner är ifyllda på raderna över och under hans. **Vad den betyder säger källan inte:** han kan ha lämnat hushållet, tjänat annorstädes eller uteblivit från nattvarden. **Ingen av tolkningarna registreras.**
...
|---|---|---|---|---|
| `Jonas` | 1861–1865, husförhörslängdens barnkolumn | TRANSCRIBED | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | **Källans form — enbart förnamnet.** Barnen förs utan efternamn under `Barn:`. |
| `Jonas Andersson` | aktens visningsnamn | LEAD | — | **Ingen källa skriver efternamnet.** Det är ett patronymikon efter fadern Anders och **måste märkas som projektets normalisering** i varje sökning. |
| `Jonas Anders son` | ej belagd | LEAD | — | **Måste ingå i varje sökning.** Patronymikon skrevs växelvis fullt ut och förkortat i tidens längder. |

## Påståenden

| ID | Påstående | Status | Tillförlitlighet | Belägg | Kommentar |
|---|---|---|---|---|---|
| A-0637 | Namnet var Jonas. | TRANSCRIBED | hög | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Barnkolumnen; patronymikon efter fadern Anders. |
| A-0638 | Hen var född 1831-06-15 i Degerfors församling. | TRANSCRIBED | hög | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Exakt datum i uppslaget. |
| A-7839 | **Hela den egna raden är utvunnen.** `Koppor.` bär `v` och `Läser och förstår` en kunskapsbåge. **Inflyttningscellen bär `d:o`** — ett dittotecken under broderns `p:a Brån[?]`, alltså **samma hänvisning som Olofs.** `Anteckningar` bär en kort egen not vars ord läses `…Bores[?]`. **Döds- och utflyttningsfälten är lästa tomma.** Årskolumnerna bär nattvardsbråk **endast under 1861**; **1862–1865 är lästa tomma.** | TRANSCRIBED | hög | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Ny läsning av den **redan sparade** bilden `A0001442_00171` 2026-09-10 i T-0185; ingen ny arkivsökning. **Uppslagets tryckta kolumner är redovisade** i citationens tillägg samma dag. **De tomma fälten är lästa nollor** — samma kolumner är ifyllda på andra rader i samma hushåll. |
...
|---|---|---|---|---|---|
| 1831-06-15 | **född** — hushållsuppgift, **ingen läst födelsepost** | Degerfors församling | — | föräldrarnas | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) |
...
| perioden | **inflyttningscellen bär `d:o`** under broderns hänvisning | — | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Övriga flyttfält är lästa tomma. |
...
|---|---|---|---|---|
| 1861–1865 | **nattvardsbråk endast under 1861**; 1862–1865 lästa tomma | Degerfors församling | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Fraktionerna är prövade men **reserverade**: årskolumnerna ligger långt från namnkolumnen och raderna tätt. |
...
Jonas var **det andra av nio syskon** i Rödå, född den 15 juni 1831. Han
delade sin äldre brors inflyttningshänvisning — hans cell bär `d:o` under
Olofs `p:a Brån[?]` — och bodde hemma utan eget stånd vid trettio års ålder.

**Och sedan tystnar hans rad.** Nattvardsbråk står under **1861 och ingen
annan gång**; åren 1862–1865 är **lästa tomma** medan broderns och systerns
motsvarande fält är ifyllda. **Hans namn är ändå inte överstruket**, och
ingen utflyttning är noterad.

**Vad tystnaden betyder säger källan inte.** Han kan ha lämnat hushållet utan
att prästen förde det, han kan ha uteblivit från förhör och nattvard, eller
han kan ha dött — men dödskolumnen är läst tom. **Ingen av tolkningarna
registreras**, och frågan är aktens enda.

## Forskningsfrågor och konflikter

1. **Varför upphör hans noteringar efter 1861?** Se profilens Q-01.
2. **Födelsedatumet är en hushållsuppgift.** Degerfors födelse- och dopbok för
   1831 är inte läst, och **den vore det första oberoende belägget** för
...
Rubriken löd `P-0151: Jonas`. Den lyder nu `P-0151: Jonas, andre sonen i Rödå`, eftersom
