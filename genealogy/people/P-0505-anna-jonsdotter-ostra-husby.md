# P-0505: Anna Jonsdotter i Östra Husby
...
- Trädverkan: `AVVAKTAR` — `Identitetsläge` är `OLÖST`. Hennes enda datering
  är en ålder i sonens post, och hennes ursprung är okänt; ingen anlinje får
  passera uppåt genom henne. Relationen nedåt till sonen är originalbelagd.
- Kontraktsgranskning: `UNDERKÄND`
- Forskningsprofil: [P-0505](../research-profiles/P-0505.md) — individuell
  granskning 2026-09-09, T-0170.

## Identitet

Anna Jonsdotter är bondhustru i byn `Wiiklo[?]` i Östra Husby och mor till
[Carl Månsson](P-0360-carl-mansson-gaddestad.md), född 1796-10-28.

Hon förekommer i **ett original**: sonens födelse- och dopnotis i Östra Husby
C/4 sida 246, post nr 44, där hon skrivs `hu Anna Jonsdotter 38 år` efter
...
|---|---|---|---|---|---|
| Oktober 1757–oktober 1758 | Född, enligt åldern `38 år` i sonens födelsepost; ort okänd | Okänd | — | Okänt | [C-0838](../citations/C-0838-ostra-husby-C4-carl-fodd-1796.md) |
...
|---|---|---|---|---|
| 1796 | Byn `Wiiklo[?]` | Östra Husby församling | [C-0838](../citations/C-0838-ostra-husby-C4-carl-fodd-1796.md) | **Ny uppgift 2026-09-09.** Hennes enda belagda hemvist, och hon står där som makens hustru. |

Hon har **ingen belagd flyttning**, och var hon växte upp är okänt. Med byn
läst finns för första gången ett avsnitt att söka i socknens
husförhörslängder.
...
|---|---|---|---|---|
| 1796 | `hu` — hustru till en bonde | `Wiiklo[?]`, Östra Husby | [C-0838](../citations/C-0838-ostra-husby-C4-carl-fodd-1796.md) | Civilstånd, inte yrke. En bondhustru bar gårdens inomgårdsarbete, men det är allmän historisk kontext och ingen personuppgift. |
...
1757–1758. Inget civilt eller rättsligt spår är sökt. Bedömningen är
...
Anna Jonsdotter framträder i **en enda post**. Den 28 oktober 1796 födde hon
sonen Carl, och två dagar senare döptes han. Posten kallar henne `hu Anna
Jonsdotter 38 år` efter maken `Bond. Måns Håkansson i Wiiklo[?]`.
[C-0838](../citations/C-0838-ostra-husby-C4-carl-fodd-1796.md)

Åldern var aldrig omräknad. `38 år` i oktober 1796 ger födelsetid mellan
oktober 1757 och oktober 1758 — ett intervall, inte ett datum, och åren 1757,
1758 och möjligen 1756 måste alla prövas. Att åldern är **hennes** och inte
makens är samtidigt fastställt: uppslagets samtliga poster bär exakt en
ålder, placerad efter moderns namn. [A-7480](#påståenden),
[A-7481](#påståenden)

Familjens by var oläst. Citationen skrev att ortsordet inte var tillräckligt
säkert läst, men vid 500 % förstoring framträder bokstavsföljden `Wiiklo` med
möjlig avslutande `ö`. Identifieringen mot socknens byar är en katalogfråga —
...
- Genomsökt: sonens samtidiga födelsenotis 1796, nu utvunnen inklusive by,
  ålderskolumnens innebörd, åldersintervallet och vittnesfältet, samt den
  senare hushållskedja som sluter sonens identitet.
...
sin första profil. Inget A-id är borttaget; A-7480–A-7483 tillkommer ur den
redan sparade fullsidan utan ny arkivåtkomst.

**Fyra fynd i en post som kallades utläst.** Åldern var aldrig omräknad till
ett intervall; att åldern är hennes och inte makens var inte fastställt; byn
var oläst; och vittnesfältet var aldrig avskrivet.
...
Den förbisåg att åldern ändå ger ett **sökbart intervall**, och att posten
innehöll en by som aldrig lästs.
