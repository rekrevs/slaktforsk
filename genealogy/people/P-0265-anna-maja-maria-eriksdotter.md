# P-0265: Anna Maja (Maria) Eriksdotter
...
- Källbredd: `PÅGÅR` — **ändrad från `KLAR` 2026-09-09.** Postens
  ...
  akten för första gången.
- Identitetsgranskning: `GODKÄND`
- Trädverkan: `AVVAKTAR` — `Identitetsläge` är `OLÖST`: hennes levnadsår är
  sekundära, och barnets vuxenidentitet är återöppnad.
- Kontraktsgranskning: `UNDERKÄND`
- Forskningsprofil: [P-0265](../research-profiles/P-0265.md) — individuell
  granskning 2026-09-09, T-0171.

## Identitet

Anna Maja Eriksdotter är hustru på Krogen i Björsäter och mor till det barn
...
kommer i övrigt **enbart** från en sekundär personakt utan källhänvisningar.
...
|---|---|---|---|---|---|
| Juni 1789–juni 1790 | Född enligt postens åldersuppgift `28`; den sekundära akten anger 1791 | Okänd | — | Okänt | [C-0833](../citations/C-0833-bjorsater-C3-johan-petter-urbom-fodd-1818.md), [C-0248](../citations/C-0248-stig-lundqvist-johan-petter-urbom-familjeled.md) |
| 1818-06-03 | Barnet Johan Petter föds; döpt den 7 juni med fyra vittnen | Krogen, Björsäter | Smedshustru | Maken och nyfött barn | [C-0833](../citations/C-0833-bjorsater-C3-johan-petter-urbom-fodd-1818.md) |
| Uppgivet 1856 | Död enligt den sekundära personakten | Okänd | — | — | [C-0248](../citations/C-0248-stig-lundqvist-johan-petter-urbom-familjeled.md) |

**Endast den mellersta hållpunkten vilar på ett original**, och den första är
ett intervall härlett ur postens åldersuppgift. Den sista är sekundär.

## Boställen och flyttar

| Tid | Från/till eller boställe | Fastighet/adress | Belägg | Kommentar |
|---|---|---|---|---|
| 1818 | `Krogen` | Björsäter församling | [C-0833](../citations/C-0833-bjorsater-C3-johan-petter-urbom-fodd-1818.md) | Hennes enda originalbelagda plats, och hon står där som smedens hustru. |

Ingen flyttning är belagd. Som **hantverkarhustru** kan hon ha kommit
utifrån, och Björsäters flyttningslängder är inte sökta för henne; se
A-7582.
...
omkring 1789–1791, och gift med en civil hantverkare — till skillnad från
kohortens soldathustru [P-0235](P-0235-britta-thomsdotter-nysatra.md), där
rullorna är en personbunden väg. Inget civilt eller rättsligt spår är sökt.
...
Anna Maja Eriksdotter var hustru till smeden Lorentz Urbom på Krogen i
Björsäter. Den 3 juni 1818 födde hon sonen Johan Petter, som döptes fyra
...
modersålder: ett par bär `24` ett år och `29` året därpå. Slutsatsen `trolig
modersålder` kräver alltså en positiv kontroll i varje bok — här finns den.

Dopets fyra vittnen, utvunna i citationen redan i september men aldrig förda
till hennes akt, ger ett **negativt** utfall: torpar- och tjänstefolk i tre
namngivna torp, inget med hennes patronymikon. Dopvägen till hennes släkt är
prövad och stängd. [A-7581](#påståenden)

Att hon var **smedshustru** i en miljö utan hemman styr hennes källstrategi:
paret kan ha kommit utifrån, och makens ovanliga familjenamn är en bättre
ingång än orten. [A-7582](#påståenden)

Kopplingen till den vuxne Johan Petter Urbom är återöppnad sedan T-0135 och
prövas i T-0292.
...
- Återaktivering: **villkoret är delvis uppfyllt 2026-09-09.** Den tidigare
  ...
  sökbara. Välj inget av åren, och gör inte sekundärkällans 1791 till ett
  läst datum.
...
sin första profil. Inget A-id är borttaget; A-7580–A-7582 tillkommer utan ny
arkivåtkomst, ur redan lästa citationer.

**Huvudfyndet är att en åldersuppgift kunde tillskrivas henne med ett
positivt skäl.** C-0833 hade läst talet `28` och kallat det en trolig
modersålder utan funktionsrubrik; jämförelsen med de två sekundära årtalen
avgör att det gäller henne och inte maken. Det är hennes första originalnära
uppgift om sig själv, och den avviker ett till två år från sekundärkällans
1791.

**Två fält fanns i materialet utan att nå akten:** dopets fyra vittnen,
utvunna i T-0135, och yrkesuppgiftens konsekvens för hennes egen
källstrategi.
...
Bedömningen var riktig om modersrollen och om de sekundära årtalen. Den
förbisåg att posten själv bar en åldersuppgift som kunde tillskrivas henne.
...
> ## Identitet
>
> Anna Maja Eriksdotter på Krogen i Björsäter, mor till Johan Petter Urbom i
> dennes egen födelsenotis 1818. Formen Maria och levnadsåren 1791–1856
