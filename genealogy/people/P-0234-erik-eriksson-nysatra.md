# P-0234: Eric Sik i Nysätra

**Släktled:** farmors morfars farmors far till
...
- Trädverkan: `AVVAKTAR` — `Identitetsläge` är `OLÖST`: ingen egen ålder,
  inget ursprung, och hans patronymikon är okänt. Relationen nedåt till
  dottern är originalbelagd.
- Kontraktsgranskning: `UNDERKÄND`
- Forskningsprofil: [P-0234](../research-profiles/P-0234.md) — individuell
  granskning 2026-09-09, T-0171.

## Identitet

Eric Sik är far till den direkta anan
...
`Christ. Bonden Eric Erik[ss.]` med reservationen att patronymikonet var
`förkortat/trångt skrivet`. Vid 450 % förstoring står i stället `Sik` — ett
soldatnamn av västerbottnisk typ — och ståndsordet är längre än
...
|---|---|---|---|---|
| [P-0235 Britta Thomsdotter](P-0235-britta-thomsdotter-nysatra.md) | hustru | Nysätra 1798; posten anger `N:o 63` | TRANSCRIBED | [C-0199](../citations/C-0199-nysatra-C4-magdalena-eriksdotter-fodd-1798.md) |
...
Hans föräldrar och syskon är okända, och hans **patronymikon är okänt** —
`Sik` är ett soldatnamn. Vittnena är sociala uppgifter, inte relationer.

## Tidslinje

| Datum/intervall | Händelse | Plats | Roll/yrke | Hushåll | Belägg |
|---|---|---|---|---|---|
| 1798-09-23 | Dottern Magdalena föds och döps samma dag | Nysätra; platsangivelsen `N:o 63` | Soldat[?] | Hustru och nyfödd dotter | [C-0199](../citations/C-0199-nysatra-C4-magdalena-eriksdotter-fodd-1798.md) |

**Akten har en enda hållpunkt.** Ingenting före eller efter september 1798 är
belagt, och han har ingen åldersuppgift.
...
Eric Sik framträder i **en enda post**: dotterns födelse- och dopnotis den 23
september 1798 i Nysätra.

Granskningen 2026-09-09 rättade två felläsningar i samma cell. Citationens
arbetsavskrift skrev `Christ. Bonden Eric Erik[ss.]` med reservationen att
...
Platsangivelsen `N:o 63` fick uttryckligen inte behandlas som gård eller rote
utan stöd. Stödet finns nu: uppslagets övriga poster bär bynamn i samma
kolumn — Öttersmark, Risvattnet, Flarken, Klingsjön, Gumboda — medan just
hans bär ett nummer, och en soldat skrevs normalt med sitt rotenummer.
[A-7551](#påståenden)

Detta gör aktens svagaste tema till dess starkaste. En indelt soldat finns i
**generalmönsterrullor**, som namnger rote, ålder, ofta födelseort, tjänsteår
och avgång — exakt de uppgifter akten saknar. Ingen rulla är sökt.

Dopets tre vittnesled var också oregistrerade: en bonde med hustru i
**Trehörningen**, en dräng på samma ort och en piga i `Öttersmark[?]`. Inget
vittne bär namnet Sik. [A-7552](#påståenden)
...
- Genomsökt: dotterns samtidiga födelse- och dopnotis 1798, nu utvunnen
  inklusive rättad namn- och ståndsläsning, platsangivelsen och
  vittnesfältet.
...
- Återaktivering: villkoret är uppfyllt 2026-09-09. Den tidigare
  ...
  **rote**, och därmed öppnas rullorna. Behandla ändå inte rotetolkningen som
  fastställd förrän en rulla eller roteförteckning bekräftar den.
...
sin första profil. Inget A-id är borttaget; A-7550–A-7552 tillkommer ur den
...
Den upphävda namnformen bevaras i Namnformer med status `REJECTED` och i
A-1402:s kommentar, där också den ursprungliga lydelsen står i sin helhet.

`Källbredd` är ändrad från `KLAR` till `PÅGÅR`. Äldre lydelse, ersatt
2026-09-09:

> - Konsolidering: `GRANSKAD` 2026-09-04 (T-0044)
> - Källbredd: `KLAR` — fadersrollen är belagd, men nuvarande källprofil kan
>   inte säkert öppna hans egen generation.

Bedömningen var riktig om att den dåvarande källprofilen inte kunde öppna
hans generation — men profilen byggde på en felläsning. Med `Soldaten Eric
Sik` och `N:o 63` som rote finns en hel källklass som aldrig övervägts.
