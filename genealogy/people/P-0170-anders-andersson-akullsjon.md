...
- Profil: [P-0170](../research-profiles/P-0170.md) — daterad PK-bedömning, tio
...
| `Anders Andersson` | aktens visningsnamn | TRANSCRIBED | [C-0121](../citations/C-0121-maria-christina-fodelse-1840.md) | Normaliserad form av samma led. |

## Påståenden

| ID | Påstående | Status | Tillförlitlighet | Belägg | Kommentar |
|---|---|---|---|---|---|
| A-0746 | Bondesonen Anders Andersson i Åkullsjön var dopvittne åt Maria Christina 1840. | TRANSCRIBED | hög | [C-0121](../citations/C-0121-maria-christina-fodelse-1840.md) | `And.` normaliseras till Anders; ingen vidare identitet antas. |
| A-7849 | **Vittnesledet är fullt utvunnet.** **Tre led står i källan, och ett av dem är en förkortning:** ståndet
`Bondesonen`, namnet `And. Andersson` och ortledet `ibidem`. **Inget av dem är
ett eget datum**, och `ibidem` är inte ens ett ortnamn utan en hänvisning till
föregående vittnes by. | TRANSCRIBED | hög | [C-0121](../citations/C-0121-maria-christina-fodelse-1840.md) | Konsoliderat 2026-09-10 i T-0186. **Ingen ny arkivsökning.** Omläsning av den redan sparade helbilden `A0004528_00091`; se citationens tillägg samma dag. **Att åldern saknas är en källgräns, inte en läsosäkerhet** — dopvittneskolumnen har ingen åldersruta. |
...
|---|---|---|---|---|
| 1840 | se vittnesledets ståndsbeteckning ovan | Åkullsjön | [C-0121](../citations/C-0121-maria-christina-fodelse-1840.md) | **`Bondesonen` är en ställning i ett hushåll, inte ett yrke** — och den upphörde när han gifte sig eller tog eget hemman. |
...
|---|---|---|---|---|
| 1840-10-31 | **betrodd som dopvittne** | församlingen | [C-0121](../citations/C-0121-maria-christina-fodelse-1840.md) | Vittnesrollen förutsatte myndighet och gott anseende. **Att han förs som bondeson och inte som bonde talar för att han var ogift**, men slutsatsen dras inte som ett belägg. |
...
Den 1840-10-31 stod Anders Andersson fadder när [P-0095 Maria Christina Hansdotter](P-0095-maria-christina-hansdotter.md) döptes. **Det är allt
...
1. **Vilken bondes son var han?** Se profilens Q-01.
...
Rubriken saknade år och roll. Den lyder nu `P-0170: Anders Andersson, bondeson i Åkullsjön, dopvittne 1840`, eftersom
