...
Hans rad bär en anteckning som ingen tidigare avskrift läst: i kolumnen
`Fräjd och enskilda anteckningar.` står **`sinnessvag`**. Det är källans egen
samtidsterm och registreras som sådan, utan modern tolkning. Se
[A-7270](#påståenden).

Han var 29 år när boken lades upp 1861 och 33 när den avslutades 1865, och han
står hela tiden ogift i föräldrahushållet. `Död.`-kolumnen är läst och tom,
alltså levde han 1865.

## Namnformer

| Form | Användning/tid | Status | Belägg | Kommentar |
|---|---|---|---|---|
| Anders Gustaf | Rad 3 i Helgesta A I/15, 1861–1865 | TRANSCRIBED | [C-0317](../citations/C-0317-alund-familj-helgesta-AI15-lota-sida-179.md) | Endast förnamnen står på raden; efternamnet Ålund följer familjegruppen och är inte utskrivet för honom. |
| Anders Gustaf Ålund | Projektets visningsnamn | — | — | Normaliserad form. Formen `Åhlund` med stumt `h`, som faderns dopnotis använder för farfadern, måste prövas jämsides vid sökning. |
...
|---|---|---|---|---|
| [P-0329 Carl Fredrik Ålund](P-0329-carl-fredrik-alund.md) | far | Löta, Helgesta; markerad `S.` i hans familjegrupp | TRANSCRIBED | [C-0317](../citations/C-0317-alund-familj-helgesta-AI15-lota-sida-179.md) |
...
| [P-0332 Hedda Lovisa Ålund](P-0332-charlotta-lovisa-alund.md) | syster | Född 1835-02-28 i Gryt; närmast yngre syskon | TRANSCRIBED | [C-0317](../citations/C-0317-alund-familj-helgesta-AI15-lota-sida-179.md) |
...
Han har ingen belagd hustru och inga belagda barn; `Äktenskap`-kolumnerna är
lästa och tomma. Inga faddrar är kända, eftersom hans dopnotis i Gryt är oläst.

## Tidslinje

| Datum/intervall | Händelse | Plats | Roll/yrke | Hushåll | Belägg |
|---|---|---|---|---|---|
| 1832-04-26 | Uppgiven födelse; egen dopnotis inte läst | Gryt | Barn | Carl Fredrik Ålund och Maja Catharina Carlsdotter | [C-0317](../citations/C-0317-alund-familj-helgesta-AI15-lota-sida-179.md) |
| 1857 | Flyttar med familjen från Gryt till Löta; ingen egen inflyttningsuppgift | Gryt → Löta, Helgesta | Son | Föräldrar och syskon | [C-0317](../citations/C-0317-alund-familj-helgesta-AI15-lota-sida-179.md) |
| 1861–1865 | Rad 3 i husförhörslängden, ogift son, med nattvardstecken 1862–1865 och anteckningen `sinnessvag` | Löta, Helgesta | Son | Föräldrar och syskon | [C-0317](../citations/C-0317-alund-familj-helgesta-AI15-lota-sida-179.md) |

Hans liv består av tre hållpunkter, varav bara den sista är en läst rad om
honom själv. Åren 1832–1857 i Gryt är helt tomma, och efter 1865 är han okänd
— han var då 33 år och levde.
...
|---|---|---|---|---|
| 1861–1865 | Enbart `S.` för son; ingen yrkes-, närings- eller ståndsuppgift | Löta, Helgesta | [C-0317](../citations/C-0317-alund-familj-helgesta-AI15-lota-sida-179.md) | Namnkolumnen efterfrågar stånd, embete, yrke och näringsfång men har inget utskrivet för honom, trots att han var 29–33 år. Ingen slutsats om försörjning dras. |
| 1861–1865 | Råtecken i tre av fyra `Läser`-kolumner; `Förstår.` läst och tom | Helgesta församling | [C-0317](../citations/C-0317-alund-familj-helgesta-AI15-lota-sida-179.md) | Grafiska tecken utan modern kunskapstolkning. `Förstår.` är tom på uppslagets samtliga nio rader och säger därför inget om honom särskilt. |

Egen ekonomi, arv och försörjning är okända.
...
Han fyllde 21 år 1853, alltså inom beväringstiden. Kolumnen `Fräjd och
enskilda anteckningar.` på hans rad bär `sinnessvag` men **ingen
...
dödbok skulle visa om anteckningen följer med, ändras eller försvinner, och
sockenstämmoprotokollen om församlingen vidtog någon åtgärd.

## Media och personliga källor

| Objekt | Datum | Upphov/provenans | Citation | Lokal fil |
|---|---|---|---|---|
| Helgesta A I/15, Löta sida 179, hans rad 3 | Läst 2026-08-23; kolumnredovisad 2026-09-09 | Riksarkivet, bild `C0006610_00149` | [C-0317](../citations/C-0317-alund-familj-helgesta-AI15-lota-sida-179.md) | [C-0317-riksarkivet-helgesta-AI15-bild-149-sida-179.jpg](../media/C-0317-riksarkivet-helgesta-AI15-bild-149-sida-179.jpg) |

Inget personligt material och ingen egen hand är känd.

## Biografisk sammanfattning

Anders Gustaf Ålund föddes den 26 april 1832 i Gryt som äldsta barnet till
Carl Fredrik Ålund och Maja Catharina Carlsdotter. Om de första
tjugofem åren vet projektet ingenting; hans dopnotis i Gryt är oläst, och
familjen flyttade 1857 till Löta i Helgesta utan att hans egen rad fick någon
inflyttningsuppgift.
[C-0317](../citations/C-0317-alund-familj-helgesta-AI15-lota-sida-179.md)

I husförhörslängden 1861–1865 står han som rad 3, ogift son i
föräldrahushållet, från 29 till 33 års ålder. Namnkolumnen — som efterfrågar
stånd, yrke och näringsfång — har ingenting utskrivet för honom, och han har
varken vigsel-, utflyttnings- eller dödsuppgift. Han har nattvardstecken från
1862.

Det som granskningen 2026-09-09 tillförde är en enda cell, och den är den
tyngsta uppgiften som finns om honom: i kolumnen `Fräjd och enskilda
anteckningar.` står **`sinnessvag`**. Ordet är källans eget och registreras som
ordalydelse; det översätts inte till någon modern diagnos, och anteckningen
saknar varje uppgift om orsak, förlopp eller vård. Att den står i
fräjdkolumnen och inte i namnkolumnens tryckta lytesrubrik, som är läst och
...
sin första profil. Inget A-id är borttaget; A-7270–A-7272 tillkommer ur den
redan sparade helbilden utan ny arkivåtkomst.

**Anteckningen `sinnessvag` var oläst.** Den är den enskilt tyngsta uppgiften
om honom och stod i en tryckt kolumn på en bild projektet läste redan
2026-08-23. Sex ytterligare kolumner på hans rad var också olästa och är nu
redovisade som tomma. Kolumnredovisningen för uppslaget ligger som ett daterat
tillägg i C-0317.

Akten hade före detta inget avsnitt utöver Identitet, Påståenden och
Relationer, och ingen anteckning om hälsa, boende, försörjning eller livsslut.
