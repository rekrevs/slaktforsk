# P-0191: Hans Larsson, uppgiven farfars far — sekundär kontext

**Släktled:** uppgiven farfars far till
...
- Profil: [P-0191](../research-profiles/P-0191.md) — daterad PK-bedömning, tio
...
**Detta är ingen dopnotis utan en privat antavla på internet**, läst
2026-08-20 och bevarad som skärmbild. Den anger honom som far till
`Nathanael Hansson` och därmed farfars far till Hans Nilsson.

**Uppgiften är `LEAD` med tillförlitlighet `låg`, och den ska förbli det.**
Sidan saknar synliga källhänvisningar, och samma sida har bevisligen fel på
en punkt som går att kontrollera: dess fadderlista för Hans Nilsson namnger
tre helt andra personer än den läsbara originalnotisen
[C-0129](../citations/C-0129-hans-nilsson-fodelse-1800.md).
En källa som motsägs av originalet där den kan prövas kan inte bära ett
antavleled där den inte kan det.

**`Antavleleden bortom P-0165 och P-0166 införs inte i den verifierade
djup-6-fronten`** — citationens egen avgränsning, och den gäller oförändrad.
...
| `Hans Larsson` | aktens visningsnamn | TRANSCRIBED | [C-0133](../citations/C-0133-hans-nilsson-sekundarpost.md) | Normaliserad form av samma led. |

## Påståenden

| ID | Påstående | Status | Tillförlitlighet | Belägg | Kommentar |
|---|---|---|---|---|---|
| A-0770 | Den privata ansedeln anger Hans Larsson som far till Nathanael Hansson och därmed farfars far till Hans Nilsson. | LEAD | låg | [C-0133](../citations/C-0133-hans-nilsson-sekundarpost.md) | Sekundär uppgift utan synliga källhänvisningar; inte införd i verifierad antavla. |
| A-7870 | **Vittnesledet är fullt utvunnet.** **Två led står i källan, och källan är sekundär:** förnamnet och
patronymikonet. Ingen ort, ingen ålder, inget datum — och ingen
...
| [P-0192 Kerstin Larsdotter](P-0192-kerstin-larsdotter-sekundar-kontext.md) | uppgiven hustru enligt samma ansedel | okänd tid | LEAD | [C-0133](../citations/C-0133-hans-nilsson-sekundarpost.md) |
...
|---|---|---|---|---|
| okänd tid | ingen uppgift om ställning i församlingen | — | [C-0133](../citations/C-0133-hans-nilsson-sekundarpost.md) | Ingenting alls är känt om hans ställning i församlingen. Källformen är en modern sammanställning, inte en samtida handling. |
...
1. Finns han i någon originalkälla? Se profilens Q-01.
...
Rubriken saknade år och roll. Den lyder nu `P-0191: Hans Larsson, uppgiven farfars far — sekundär kontext`, eftersom
