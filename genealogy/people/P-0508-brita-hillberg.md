# P-0508: Brita Hillberg

**Släktled:** morfars farmors morfars mor till
...
[Anna Greta Hillberg](P-0277-anna-greta-hillberg.md) →
[Per Hillberg vid Håsta Udde](P-0350-per-hillberg-hasta-udde.md) → hon.
...
- Trädverkan: `AVVAKTAR` — `Identitetsläge` är `OLÖST`. Hennes födelsesocken
  ...
  genom henne. Relationen nedåt till sonen är originalbelagd.
- Kontraktsgranskning: `UNDERKÄND`
- Forskningsprofil: [P-0508](../research-profiles/P-0508.md) — individuell
  granskning 2026-09-09, T-0170.

## Identitet

Brita Hillberg är änka och uttryckligen angiven mor till
...
uttryckligen ingen far till Per. Familjenamnet `Hillberg` delar hon med
sonen; om det är hennes giftonamn eller hennes eget är inte belagt.
...
|---|---|---|---|---|---|
| 1805-05-13 | Uppgiven födelse; socknen är oläst i sak och läses troligen `Forsa[?]` | Okänd | — | Okänt | [C-0842](../citations/C-0842-halsingtuna-AI13-per-hillberg-mor.md) |
| Före bokperioden | Hon blir änka; makens namn och dödsår är okända | Okänd | Änka | — | [C-0842](../citations/C-0842-halsingtuna-AI13-per-hillberg-mor.md) |
| Omkring 1857–1861 | Egen rad som `Modren` i sonens hushåll, med förhörs- och nattvardsnoteringar varje år och tom omständighetskolumn | Håsta Udde, Hälsingtuna | Änka | Sonen, hans hustru och deras barn | [C-0842](../citations/C-0842-halsingtuna-AI13-per-hillberg-mor.md) |

**Endast den sista hållpunkten vilar på hennes egen läsbara radinnehåll.** De
52 åren mellan 1805 och bokperioden har ingen hållpunkt, och hennes död är
okänd.
...
|---|---|---|---|---|
| Omkring 1857–1861 | Håsta Udde, 12:e roten, sida 218 | Hälsingtuna församling | [C-0842](../citations/C-0842-halsingtuna-AI13-per-hillberg-mor.md) | Hennes enda belagda plats, och hon bor där som sonens moder. |
| Uppgivet 1805 | Födelsesocken oläst; läses troligen `Forsa[?]` | — | [C-0842](../citations/C-0842-halsingtuna-AI13-per-hillberg-mor.md) | Ingen ort förs in i sak. Se A-7490. |

Hon har **ingen belagd flyttning**: hennes rad har inga in- eller
utflyttningsuppgifter. Hur och när hon kom till Hälsingtuna är okänt.
...
`EJ RELEVANT` för militärt på personbunden grund: hon är kvinna, född 1805.
Inget civilt eller rättsligt spår är sökt, och kolumnen `Omständigheter` är
**läst och tom** på hennes rad.
...
|---|---|---|---|---|
| Hälsingtuna A I/13 sida 218, Håsta Udde, hela sidan | Läst tidigare; omläst 2026-09-09 vid 320–900 % | Riksarkivet, bild `C0031386_00240` | [C-0842](../citations/C-0842-halsingtuna-AI13-per-hillberg-mor.md) | [C-0842-riksarkivet-halsingtuna-AI13-C0031386_00240-s218.jpg](../media/C-0842-riksarkivet-halsingtuna-AI13-C0031386_00240-s218.jpg) |

Inget personligt material och ingen egen hand är känd.

## Biografisk sammanfattning

Brita Hillberg är änka och bor som `Modren` i sonen Per Hillbergs hushåll på
Håsta Udde i Hälsingtuna. Hennes rad ger födelsedagen **13 maj 1805** och en
födelsesockencell som citationen kallade svårläst.
...
rader bär `b`. [A-7491](#påståenden), [A-7492](#påståenden)

Samma sida rymmer ett **andra Hillbergshushåll** i samma rote:
...
- Ingen konflikt finns i det lästa underlaget. Sockenläsningen är en
  **öppen** fråga, inte en motsägelse.
...
- Genomsökt: sonens slutna familjehushåll på Hälsingtuna A I/13 sida 218, nu
  utvunnet inklusive hennes egna årskolumner, kunskapsmärken och den tomma
  omständighetskolumnen, samt sidans andra Hillbergshushåll; och hans dotters
  samtidiga födelsenotis.
...
- Återaktivering: villkoret är delvis uppfyllt 2026-09-09. Den tidigare
  ...
  vilket gör Forsa till en namngiven kandidat men inte till en korsnyckel.
  Sök inte brett på datumet, och gör inte Olof Hillberg till hennes son utan
  ett original.
...
sin första profil. Inget A-id är borttaget; A-7490–A-7493 tillkommer ur den
redan sparade fullsidan utan ny arkivåtkomst.

**Uppgiften från T-0156 är prövad.** T-0156 noterade att sockencellen i
...
Därtill var hennes egna kolumner outvunna: årskolumnerna 1857–1861,
kunskapsmärkena och den tomma omständighetskolumnen. Sidans andra
Hillbergshushåll var inte noterat.

`Källbredd` är ändrad från `KLAR` till `PÅGÅR`. Äldre lydelse, ersatt
2026-09-09:

> - Konsolidering: `GRANSKAD` 2026-09-04 (T-0042)
> - Källbredd: `KLAR` — exakt datum finns, men den nödvändiga orts- eller
>   föräldrahemsnyckeln saknas.

Bedömningen var riktig om att ortnyckeln saknades. Den byggde på att cellen
var oläsbar — men den var **oförstorad**, och sidan innehöll dessutom fyra
outvunna uppgifter om henne själv.
