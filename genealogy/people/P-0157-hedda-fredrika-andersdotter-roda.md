# P-0157: Hedda Fredrika, yngst i Rödå
...
- Profil: [P-0157](../research-profiles/P-0157.md) — daterad PK-bedömning, tio
...
- Hela den egna raden är nu utvunnen ur den redan sparade bilden
  `A0001442_00171`; ingen ny arkivsökning. Se A-7847.

## Identitet

Yngsta barnet till bonden och nämndemannen [P-0145 Anders Olofsson](P-0145-anders-olofsson-namndeman-roda.md) och hans hustru [P-0148 Sofia Magdalena Jonsdotter](P-0148-sofia-magdalena-jonsdotter.md) i
**Rödå** i Degerfors, född 1854-12-16 enligt föräldrahushållets
husförhörslängd, sex år när längden lades upp 1861.
...
**Koppympningen är hennes enda egna uppgift utöver namn och datum**, och den är inte självklar: hon var sex år 1861, och `v` på hennes rad visar att ympningen redan var gjord. De tomma årskolumnerna är väntade — hon var elva år när längden slutade. Aktens hela innehåll ryms på en rad, och det är ingen brist i utvinningen utan i källan.
...
|---|---|---|---|---|
| `Hedda Fredrika` | 1861–1865, husförhörslängdens barnkolumn | TRANSCRIBED | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Källans form — enbart förnamnet. Barnen förs utan efternamn under `Barn:`. |
| `Hedda Fredrika Andersdotter` | aktens visningsnamn | LEAD | — | **Ingen källa skriver efternamnet.** Det är ett patronymikon efter fadern Anders och måste märkas som projektets normalisering i varje sökning. |
| `Hedda Fredrika Anders dr` | ej belagd | LEAD | — | Måste ingå i varje sökning. Patronymikon skrevs växelvis fullt ut och förkortat i tidens längder. |

## Påståenden

| ID | Påstående | Status | Tillförlitlighet | Belägg | Kommentar |
|---|---|---|---|---|---|
| A-0649 | Namnet var Hedda Fredrika. | TRANSCRIBED | hög | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Barnkolumnen; patronymikon efter fadern Anders. |
| A-0650 | Hen var född 1854-12-16 i Degerfors församling. | TRANSCRIBED | hög | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Exakt datum i uppslaget. |
| A-7847 | Hela den egna raden är utvunnen. `Koppor.` bär `v` och `Läser och förstår` en kunskapsbåge med en avvikande prickad form. Samtliga övriga egna fält är lästa tomma: inflyttning, utflyttning, död, `Anteckningar` och alla fem årskolumnerna 1861–1865. | TRANSCRIBED | hög | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) | Ny läsning av den redan sparade bilden `A0001442_00171` 2026-09-10 i T-0185; ingen ny arkivsökning. Uppslagets tryckta kolumner är redovisade i citationens tillägg samma dag. De tomma fälten är lästa nollor — samma kolumner är ifyllda på andra rader i samma hushåll. |
...
|---|---|---|---|---|---|
| 1854-12-16 | född — hushållsuppgift, ingen läst födelsepost | Degerfors församling | — | föräldrarnas | [C-0111](../citations/C-0111-anders-olofsson-hushall-roda-1861.md) |
...
Hedda Fredrika var yngst av nio syskon i Rödå, född den 16 december 1854.
Hon var sex år när längden lades upp och elva när den slutade.

**Aktens hela innehåll ryms på en rad**, och det är ingen brist i utvinningen
utan i källan: namnet, födelsedatumet, en kunskapsbåge — och
koppympningens `v`, som är hennes enda egna uppgift utöver namn och datum.
Den är inte självklar: hon var sex år 1861, och markeringen visar att
ympningen redan var gjord.

Övriga fält är lästa nollor, alla fem årskolumnerna medräknade. Hon var
under nattvardsåldern under hela perioden, och efter 1865 slutar längden.
...
2. Födelsedatumet är en hushållsuppgift. Degerfors födelse- och dopbok för
   1854 är inte läst, och den vore det första oberoende belägget för
...
Rubriken löd `P-0157: Hedda Fredrika`. Den lyder nu `P-0157: Hedda Fredrika, yngst i Rödå`, eftersom
