...
- Profil: [P-0300](../research-profiles/P-0300.md) — daterad PK-bedömning, tio
  teman, söknycklar och källvägar.
- Identitetsnivå **`UNDERKÄND`**, `Identitetsläge: PRÖVAT`;
  `Trädverkan: EJ BÄRANDE`. Full nivå `UNDERKÄND`.
- **Aktens underlag är familjeuppgifter.** **Ett födelseår, ett gift namn och en bostadsuppgift som är historisk.** Se A-7899.
...
| A-7899 | **Aktens underlag är konsoliderat och dess gränser utskrivna.** **Ett födelseår, ett gift namn och en bostadsuppgift som är historisk.** | TRANSCRIBED | hög | [C-0263](../citations/C-0263-jan-christer-om-arne-anki-och-sidogrenar.md), [C-0266](../citations/C-0266-jan-christer-slaktkronika-arne-2011.md), [C-0267](../citations/C-0267-jan-christer-minnen-flen-sodertalje.md) | Konsoliderat 2026-09-10 i T-0192. **Ingen ny arkivsökning, ingen ny läsning och ingen ny uppgift om personen.** Assertionen redovisar **vad de befintliga uppgifterna tillsammans bär och var de slutar** — se identitetsavsnittet. **Integritetsminimering:** ingen adress och inga privata detaljer utöver nödvändig identitets- och relationsinformation. |

## Relationer

| Person | Relation | Tid/plats | Status | Belägg |
|---|---|---|---|---|
| [P-0009 Ada Wilhelmina Jansson](P-0009-ada-wilhelmina-jansson.md) | mor | — | TRANSCRIBED | C-0263 |
