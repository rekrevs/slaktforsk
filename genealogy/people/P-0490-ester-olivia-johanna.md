# P-0490: Ester Olivia Johanna, född 1891
...
- Profil: [P-0490](../research-profiles/P-0490.md) — daterad PK-bedömning, tio
...
Född 1891-12-21, död 1967-11-09, utan gravsättningsdag i registret i familjegraven på Sollentuna kyrkogård,
...
gravregistret, alltså 76 år efter födelsen och i en administrativ
andrahandskälla. Den säger ingenting om namnbruket under barndomen.

Hon är den enda av de sex gravsatta halvsyskonen utan
gravsättningsdag i registret. De övriga fem har alla en, med intervall på
tre veckor till en månad efter dödsdagen. Frånvaron är registrets, inte
familjens — den säger ingenting om begravningen, bara att fältet inte är
ifyllt. Den redovisas som en läst lucka i en administrativ andrahandskälla.

**Hon föddes femton månader efter sin äldsta syster** — det tätaste
syskonintervallet i familjen — och dog yngst av de fyra syskonen i denna
kohort, sjuttiofem år gammal.
...
|---|---|---|---|---|
| `Ester Olivia Johanna` | folkräkningarna 1900 och 1910, utan efternamn | TRANSCRIBED | [C-0806](../citations/C-0806-riksarkivet-folkrakning-1900-kungsholm-fredberg.md), [C-0774](../citations/C-0774-folkrakning-1910-klara-fredbergfamilj.md), [C-0945](../citations/C-0945-fredbergs-familjegrav-sollentuna.md) | Originalens namnkolumn skriver barnen utan efternamn; faderns namn bevisar inte hennes eget namnbruk. |
| `Fredberg, Ester Olivia Johanna` | gravregistret, gravsättning 1967 | TRANSCRIBED | [C-0945](../citations/C-0945-fredbergs-familjegrav-sollentuna.md) | **Enda belägget för efternamnet.** Administrativ andrahandskälla; den säger inget om namnbruket under barndomen. |
...
|---|---|---|---|---|---|
| 1891-12-21 | född — dagen kommer ur gravregistret, året ur folkräkningarna; ingen läst födelsenotis | Kungsholm | barn | föräldrarnas | [C-0945](../citations/C-0945-fredbergs-familjegrav-sollentuna.md) |
...
| mellan 1910 och 1967 | obelagt — men hon var skriven i Sollentuna vid sin död | — | — | — | [C-0945](../citations/C-0945-fredbergs-familjegrav-sollentuna.md) |
| 1967-11-09 | död, 76 år gammal | Sollentuna | — | — | [C-0945](../citations/C-0945-fredbergs-familjegrav-sollentuna.md) |
| — | ingen gravsättningsdag i registret — en läst lucka i en administrativ källa | Sollentuna kyrkogård | — | — | [C-0945](../citations/C-0945-fredbergs-familjegrav-sollentuna.md) |

**Livslinjen har två ändpunkter och ett tomt mitt.** Mellan 1910 och
dödsåret 1967 finns ingenting — 57 år.
...
| vid dödsfallet 1967-11-09 | skriven i Sollentuna | — | [C-0945](../citations/C-0945-fredbergs-familjegrav-sollentuna.md) | Att hon var skriven där är belagt. Att familjen flyttade dit samlat är det inte — halvsyskonens hemort gäller olika dödsår. |
| mellan 1910 och 1967 | obelagt | — | — | **Ingen flyttkedja är läst.** |
...
|---|---|---|---|
| 1967-11-09 | död, 76 år gammal | [C-0945](../citations/C-0945-fredbergs-familjegrav-sollentuna.md) | Gravregistret är en administrativ andrahandskälla. Dödsdatumet bör bekräftas i Sollentunas dödbok innan det behandlas som originalbelagt — citationens egen anmärkning. |
| — | ingen dödsorsak | — | Gravregistret anger ingen, och ingen dödbok är läst. |
| — | ingen gravsättningsdag | [C-0945](../citations/C-0945-fredbergs-familjegrav-sollentuna.md) | En läst lucka i registret, inte en uppgift om begravningen. |
...
Ester Olivia Johanna föddes den **1891-12-21** i Stockholm, som dotter till stationskarlsförmannen
Olaus Fredberg och Johanna Charlotta Jansson.
Vid folkräkningen 1900 var hon 9 år och bodde med föräldrar och fyra syskon i Jordgubben N:o 11 på Kungsholmen.

Tio år senare hade familjen flyttat till Gösen nr 4 i Klara rote 3, och
där står hon som barn i hushållet.

**Sedan tar källorna slut.** Mellan 1910 och 1967 finns ingenting —
57 år utan en enda läst uppgift.

**Hon dog den 1967-11-09, 76 år gammal, skriven i Sollentuna**, och
ligger i familjegraven på Sollentuna
...
skrivs barnen utan efternamn, och formen är nedtecknad 76
år efter födelsen.

## Forskningsfrågor och konflikter

1. Vad står i hennes egen födelsenotis i Kungsholm 1891? Dagen kommer ur
   ett gravregister, inte ur en födelsebok. Se profilens Q-01.
2. Vad hände mellan 1910 och 1967? 57 år är obelagda. Se Q-02.
...
Rubriken löd `P-0490: Ester Olivia Johanna`. Den lyder nu `P-0490: Ester Olivia Johanna, född 1891`.
