...
nya Markdownfiler. [Fryst ursprung](../../genealogy/research-plan.md)
(SHA-256 `6a3b21976c7d063b0124f4592b6923b5844bef89e1c4137dc748b8364424236d`) bevaras som historik.
...
2. Använd `node genealogy2/cli.mjs inventory` och verifierad
...
3. För berörda personer: läs aktuell full personvy, forskningsobjekt och
   hänvisade relevanta bedömningar. Använd `show`/`context` för fryst underlag.
   Inventera vad som redan är belagt,
...
6. Genomför den sakligt motiverade passagen, konsolidera och lämna utförande,
   verifiering och nästa ej utförda steg i Wotan. Batchens forskningsresultat
   bevaras en gång i operation/journal, som Wotan hänvisar till.
...
anexpansion. En fullständig kohortgenomgång kräver båda delarna enligt north star.
En avgränsad identitetsuppgift kan däremot vara DONE och en generation
trädklar med återstående livsbildsarbete; nivåerna redovisas separat.
Ett externt hinder redovisas som hinder,
...
Uppdatera den aktuella personmodellen och berättelsen genom `apply`.
Visa ersatta sammanfattningar som historiska genom versioner och tydliga
rättelsereferenser; skriv inte om det frysta arkivet.
...
Genealogy2:s versionerade person- och forskningsobjekt äger aktuellt sakläge.
`inventory` visar separata granskningsnivåer och `pedigree` den verifierade
antavlan med stopp. Äldre frontier och source-coverage är historiskt underlag.
...
Inventeringen får inte omtolka saknade bedömningar till felaktiga släktrelationer,
och ett djupmått bevisar inte fullständig livsbild. Kör relevanta kontroller
enligt arbetsvägen och Wotan. Äldre skript körs endast som arkivkontroller;
deras skrivlägen och uppdatering av frysta härledda filer används inte.
Dashboarden ändras bara vid ägarens uttryckliga beställning.
...
Följ [Riksarkivet-metoden](riksarkivet-access.md). ArkivDigital är förbjudet
för agenten. Ingen beställning, kontakt, PDF eller publicering följer
av forskningsprogrammet utan separat mandat.

[Tvåfallspiloten](../../genealogy/source-strategy-pilot-2026-09-05.md) är historisk
metodprövning. PCD-2026-09-05-013 gjorde programmet bindande;
